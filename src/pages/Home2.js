    ...
    return (
        <>
            ...
            <div className="p-20 flex flex-col justify-start items-start gap-12 bg-slate-50">
                ...
                <p className='text-lg text-neutral-800'>Are you aware of what npm packages you have installed? What do they do? When they were updated? Their issues and dependencies?
                    <br />
                    Eye of Packages is a All-Seeing Eye for your npm packages. It is aimed at helping you identify potentially harmful and/or outdated packages
                </p>
                <p className='text-neutral-700'>
                    The project is developed by <a href="https://github.com/azyzz228" target={"_blank"} className="text-blue-700 hover:text-blue-900">Aziz Abdullaev</a> and <a href="https://github.com/Chukwuemeka-Mba" target={"_blank"} className="text-blue-700 hover:text-blue-900">Chukwuemeka Mba</a> for MLH Fellowship Orientation Hackathon, Fall 2022.
                    Github link is <a href="https://github.com/azyzz228/node-packagers-checker" target={"_blank"} className="text-orange-700 hover:text-orange-900">here</a>
                </p>

                <div className=" container mx-auto flex flex-col items-center mt-8">
                    <p className='mb-4 text-sm text-neutral-800'>Insert a link to your Github repo with package.json file as well as branch name.</p>
